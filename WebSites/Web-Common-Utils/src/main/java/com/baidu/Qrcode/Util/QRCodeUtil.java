...
public class QRCodeUtil {
		    ...
		    public static File encode(String content, String imgPath, String destPath, boolean needCompress) throws Exception {
		        ...
		        while(ImageIO.write(image, FORMAT_NAME, imgFile)) {
		        	return imgFile;
		        };
		       return null; 
		    }
		     ...
		     * @throws Exception
		     */
		    public static File encode(String content, String imgPath, String destPath, boolean needCompress,String name) throws Exception {
		        BufferedImage image = QRCodeUtil.createImage(content, imgPath, needCompress);
		        mkdirs(destPath);
		        String fileName = new Random().nextInt(99999) + ".jpg";//生成随机文件名
		    ...
		    public static String decode(String path) throws Exception {
		        return QRCodeUtil.decode(new File(path));
		    		...
		    		public static void main(String[] args) throws Exception {
		    	        String text = "http://www.zhongchi.top/web/wx/redirect/wx2177d0a63a0f960f/jump?schoolId=5cb92bd41647eb08d8cc706c&classId=5cc6553c1647eb1b30315fc2";  
		    	        String url="http://www.baidu.com";
		    	        File file = QRCodeUtil.encode(text, "d:/demo/2.jpg", "d:/啊彼此", true);  
