...
public class TemplateMsgUtil {
		...
		public  templateService service=(em,msg,url)->{
			...
			if(em==TemplateIdEnum.RepairToast) {
				...
				templateMessage.addData(new WxMpTemplateData("keyword1",msg.getSchool().getName(),"#000000"));
				templateMessage.addData(new WxMpTemplateData("keyword2","点击查看","#000000"));
				templateMessage.addData(new WxMpTemplateData("keyword3",msg.getSchool().getAddr(),"#000000"));
				templateMessage.addData(new WxMpTemplateData("keyword4",Common.fromDateH(msg.getCreateTime()),"#000000"));
			...
			if(em==TemplateIdEnum.toManToast) {
				...
				templateMessage.addData(new WxMpTemplateData("keyword2",msg.getSchool().getAddr(),"#000000"));
			...
			if(em==TemplateIdEnum.feedback) {
				...
				templateMessage.addData(new WxMpTemplateData("keyword2",msg.getSchool().getAddr()+"("+msg.getSchool().getName()+")","#000000"));
				templateMessage.addData(new WxMpTemplateData("remark","请耐心等待","#000000"));
				templateMessage.setUrl(url);
			}
			if(em==TemplateIdEnum.resultback) {
				templateMessage.addData(new WxMpTemplateData("first","老师，您的报修已经处理完毕","#000000"));
				templateMessage.addData(new WxMpTemplateData("keyword1",msg.getRepairclass().getName(),"#000000"));
				templateMessage.addData(new WxMpTemplateData("keyword2",Common.fromDateH(msg.getCreateTime()),"#000000"));
				templateMessage.addData(new WxMpTemplateData("remark","请耐心等待","#000000"));
				templateMessage.setUrl(url);
			}
